...
from Yolov5_DeepSort_Pytorch.yolov5.utils.datasets import LoadImages, LoadStreams, VID_FORMATS
from Yolov5_DeepSort_Pytorch.yolov5.utils.general import (LOGGER, check_img_size, non_max_suppression, scale_coords,
...
def detect(source, model, data: List):
    ...
    source = '0' if source == None else source
    ...
    save_crop = False
    dnn = False
    project = ('Yolov5_DeepSort_Pytorch/runs/track')
    name = 'exp'
    exist_ok = False
